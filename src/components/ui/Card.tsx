  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <h3 className="text-xl font-serif font-semibold text-deepNavy mb-2 group-hover:text-terracotta transition-colors duration-300">{title}</h3>
        <p className="text-charcoal/80 group-hover:text-charcoal transition-colors duration-300">{description}</p>
      </div>

  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isSignUp) {
        ...
        // Create user data object with all form fields
        const userData = {
        ...
        if (signInError) {
          console.log("Supabase error:", signInError.message); // Add logging to see exact error message

          // Check for non-existent account first
          if (
            signInError.message
              .toLowerCase()
            ...
            setError({
              ...
              message:
                "We couldn't find an account with this email address. Please sign up first.",
            });
            return;
          }

          // Then check for invalid password (account exists but wrong password)
          if (
            signInError.message
              .toLowerCase()
              .includes("invalid login credentials")
              ...
              >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    >
                      Email
                      {isSignUp && <span className="text-terracotta">*</span>}
                    </label>
                    <div className="relative">
                      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  ...
                  {isSignUp && (
                    <>
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <Building size={18} className="text-charcoal/50" />
                          </div>
                          <input
                            type="text"
                            id="college"
                        ...
                        <div className="flex flex-wrap gap-2">
                          ...
                          >
                            ...
                            >
                              ...
                              />
                              <path
                                d="M12 21V13M12 21H9M12 21H15M9 18H15"
                                stroke="currentColor"
                                strokeWidth="2"
                                strokeLinecap="round"
                                strokeLinejoin="round"
                  ...
                  <div
                    className={
                      isSignUp ? "grid grid-cols-1 md:grid-cols-2 gap-4" : ""
                    }
                  >
                    <div>
                      <label
                  ...
                  {!isSignUp && (
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        ...
                        <label
                          htmlFor="remember-me"
                          className="ml-2 block text-sm text-charcoal cursor-pointer"
                        >
                          Remember me
                        </label>
                      </div>
                  ...
                  {isSignUp && (
                    <div className="flex items-start">
                      ...
                      <div className="ml-3 text-sm">
                        <label
                          htmlFor="terms"
                          className="text-charcoal/80 cursor-pointer"
                        >
                          All your information is collected, stored and
                          processed as per our data processing guidelines. By
                          signing up on NATA Prep, you agree to our{" "}
                          <a
                            href="#"

...
import { Users, MessageSquare, Calendar, Award, ArrowRight, Heart, MessageCircle, Share2, User, Search, Eye } from 'lucide-react';
  ...
  const discussions = [
    {
      ...
      content: "I've been struggling with perspective drawings, especially when it comes to complex architectural forms. Any tips or resources that helped you improve?",
      likes: 42,
      comments: 18,
      time: '2 hours ago',
    ...
    },
    {
      ...
      content: 'The mathematical section seems challenging. What topics should I focus on? Are there specific books or resources you recommend for this section?',
      likes: 35,
      comments: 24,
      time: '1 day ago',
    ...
    },
    {
      ...
      content: "I've been working on my architectural sketching skills for NATA. Would appreciate feedback on my portfolio. Link in the comments!",
      likes: 28,
      comments: 32,
      time: '3 days ago',
    ...
    },
    {
      ...
      content: "There are some changes in the NATA 2024 exam pattern. Let's discuss how this affects our preparation strategy and what new areas we need to focus on.",
      likes: 56,
      comments: 41,
      time: '5 days ago',
  ...
  const successStories = [
    {
      ...
      rank: 12,
      year: 2023,
      quote: "The community support and practice resources on this platform were instrumental in my NATA preparation. The mock tests were incredibly similar to the actual exam.",
      tips: [
    ...
    },
    {
      ...
      rank: 25,
      year: 2023,
      quote: "The drawing tools and 3D visualization features helped me understand complex spatial concepts that were difficult to grasp from textbooks alone.",
      tips: [
    ...
    },
    {
      ...
      rank: 18,
      year: 2023,
      quote: "From struggling with basic sketches to scoring in the top 20, this platform transformed my preparation journey. The community feedback was invaluable.",
      tips: [
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between">
                        <div>
                          <h3 className="font-medium text-deepNavy">{discussion.author.name}</h3>
                          <span className="text-xs text-terracotta bg-terracotta/10 px-2 py-0.5 rounded-full">
                            {discussion.author.badge}
                          </span>
                        </div>
                        <span className="text-sm text-charcoal/60">{discussion.time}</span>
                      </div>
              ...
              >
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-4">
                    <h3 className="text-lg font-medium text-white">{portfolio.title}</h3>
                    ...
                    <div className="flex items-center mt-1">
                      ...
                      />
                      <span className="text-sm text-white/90">{portfolio.author.name}</span>
                      <span className="text-xs text-white/70 ml-2">• {portfolio.author.college}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6 md:p-8">
                  <div className="flex flex-col md:flex-row md:items-center">
                    <div className="md:w-1/4 flex flex-col items-center text-center mb-6 md:mb-0">
                      ...
                      />
                      <h3 className="font-serif font-bold text-xl text-deepNavy mt-3">{story.name}</h3>
                      <div className="text-terracotta font-medium">{story.college}</div>
                    ...
                    <div className="md:w-3/4 md:pl-8 md:border-l border-gray-200">
                      <div className="text-2xl text-terracotta/80 font-serif mb-2">"</div>
                      <p className="text-charcoal/80 italic mb-6">
                        {story.quote}
                      </p>
                      
                      <h4 className="font-medium text-deepNavy mb-3">Tips for NATA Aspirants:</h4>
    ...
    <div className="min-h-screen pt-16 bg-cream">
      ...
      <div className="bg-deepNavy text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-16 relative z-10">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-serif font-bold mb-4">Community Hub</h1>
            <p className="text-xl text-white/80 mb-8">
              Connect with fellow NATA aspirants, share resources, participate in discussions, and learn from success stories
            </p>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mb-8 overflow-x-auto pb-4">
          <div className="flex space-x-4 min-w-max">
            {tabs.map((tab) => (
              ...
              >
                <span className={activeTab === tab.id ? 'text-white' : 'text-mutedGold'}>
                  {tab.icon}
                </span>
                <span>{tab.name}</span>
              </motion.button>
        ...
        >
          <div className="p-8 md:p-12">
            <h2 className="text-3xl font-serif font-bold text-deepNavy mb-8 text-center">Our Growing Community</h2>
            
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {[
                { value: '15,000+', label: 'Active Members', icon: <Users size={24} /> },
                { value: '5,000+', label: 'Discussions', icon: <MessageSquare size={24} /> },
                { value: '1,200+', label: 'Success Stories', icon: <Award size={24} /> },
                { value: '250+', label: 'Monthly Events', icon: <Calendar size={24} /> },
              ].map((stat, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 20 }}
        ...
        >
          <div className="text-center mb-10">
            <h2 className="text-3xl font-serif font-bold text-deepNavy mb-4">Meet Our Mentors</h2>
            <p className="text-charcoal/80 max-w-2xl mx-auto">
              Learn from experienced architects and NATA toppers who provide guidance, feedback, and support to help you succeed
            </p>
          </div>
